...
class ResumeProfileLanguage(CoreBase):
    __tablename__ = "resume_profile_languages"
    __table_args__ = (Index("ix_resume_profile_languages_profile_id", "resume_profile_id"),)

    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    resume_profile_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("resume_profiles.id"), nullable=False)
    idioma: Mapped[str] = mapped_column(String(64), nullable=False)
