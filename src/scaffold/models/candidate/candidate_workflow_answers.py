...
class CandidateWorkflowAnswer(CoreBase):
    __tablename__ = "candidate_workflow_answers"
    __table_args__ = (
    ...
    session_id: Mapped[int] = mapped_column(
        BigInteger, ForeignKey("candidate_workflow_sessions.id"), nullable=False
    )
    step_id: Mapped[int] = mapped_column(
        BigInteger, ForeignKey("candidate_workflow_steps.id"), nullable=False
    )
