...
class CandidateWorkflowSession(CoreBase):
    __tablename__ = "candidate_workflow_sessions"
    __table_args__ = (
        Index("ix_candidate_workflow_sessions_candidate_id", "candidate_id"),
        Index("ix_candidate_workflow_sessions_candidate_workflow", "candidate_id", "workflow_key"),
    )
